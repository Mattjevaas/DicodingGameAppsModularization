...
//    func getGameData(pageSize: Int) -> AnyPublisher<[GameModel], Error>
...
//    func isDataExist(gameId: Int) -> AnyPublisher<Bool, Error>
//    func fetchData() -> AnyPublisher<[FavoriteGameModel], Error>
//}
//
...
//        
//        return self.locale.saveData(object: gameData).eraseToAnyPublisher()
//    }
//    
//    func deleteGameData(gameId: Int) -> AnyPublisher<Bool, Error> {
//        return self.locale.deleteData(type: GameRealmEntity.self, predicate: NSPredicate(format: "gameId == \(gameId)")).eraseToAnyPublisher()
//    }
//    
//    func isDataExist(gameId: Int) -> AnyPublisher<Bool, Error> {
//        return self.locale.isDataExist(type: GameRealmEntity.self, predicate: NSPredicate(format: "gameId == \(gameId)")).eraseToAnyPublisher()
//    }
//    
//    func fetchData() -> AnyPublisher<[FavoriteGameModel], Error> {
